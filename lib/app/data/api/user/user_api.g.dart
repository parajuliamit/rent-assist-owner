...
class _UserApi implements UserApi {
  ...
  @override
  Future<AgreementResponse> getAgreements() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<AgreementResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = AgreementResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<List<RentResponse>> getRent() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<RentResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    var value = _result.data!
        .map((dynamic i) => RentResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
